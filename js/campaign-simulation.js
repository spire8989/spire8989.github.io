...
function finalizeCampaignTelemetry(
  ...
  return {
    ...
    totalFishingSessions: totals((entry) => entry.fishingSessions),
...
function summarizeCampaigns(results) {
  ...
  return {
    ...
    averageFishingSessions: averageField("totalFishingSessions"),
    ...
    averageFishingKnowledgeLearned: averageField("totalFishingKnowledgeLearned"),
