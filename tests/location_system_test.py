...
def run():
    ...
    try:
        ...
        check("document.querySelectorAll('.hub-hotspot').length === 5", "Village should expose five hotspots")
        ...
        check("document.querySelector('#provisions-card')?.dataset.provisionState === 'warning' && getComputedStyle(document.querySelector('#provisions-card')).animationName === 'none' && getComputedStyle(document.querySelector('#provisions-card')).borderTopColor !== getComputedStyle(document.querySelector('.resource-card:not(#provisions-card)')).borderTopColor", "Reduced motion removed the warning pulse without removing its visual state")
        ...
        check("document.querySelector('#provisions-card')?.dataset.provisionState === 'danger' && getComputedStyle(document.querySelector('#provisions-card')).animationName === 'none' && getComputedStyle(document.querySelector('#provisions-card')).borderTopColor !== getComputedStyle(document.querySelector('.resource-card:not(#provisions-card)')).borderTopColor", "Reduced motion removed the danger pulse without removing its visual state")
