...
def run():
    ...
    try:
        ...
        check("(() => { const visual=document.querySelector('.destination-visual'); const frame=visual.getBoundingClientRect(); const style=getComputedStyle(visual); return style.aspectRatio.replaceAll(' ', '')==='16/9' && Math.abs(frame.width/frame.height-16/9)<0.02 && [...visual.children].every(child=>{const box=child.getBoundingClientRect(); return box.left>=frame.left&&box.right<=frame.right&&box.top>=frame.top&&box.bottom<=frame.bottom;}); })()", "Hall destination hero is not an explicit contained 16:9 frame")
        ...
        check("(() => { const visual=document.querySelector('.destination-visual'); const style=getComputedStyle(visual); return style.aspectRatio.replaceAll(' ', '')==='16/9' && Math.abs(visual.clientWidth/visual.clientHeight-16/9)<0.02; })()", "Inn destination visual is not an explicit 16:9 frame")
        ...
        devtools.click('[data-action="dialogue-continue"]')
        check("(() => { const visual=document.querySelector('.destination-visual'); const style=getComputedStyle(visual); return style.aspectRatio.replaceAll(' ', '')==='16/9' && Math.abs(visual.clientWidth/visual.clientHeight-16/9)<0.02; })()", "Merchant destination visual is not an explicit 16:9 frame")
        ...
        check("(() => { const visual=document.querySelector('.destination-visual'); const style=getComputedStyle(visual); return style.aspectRatio.replaceAll(' ', '')==='16/9' && Math.abs(visual.clientWidth/visual.clientHeight-16/9)<0.02; })()", "Blacksmith destination visual is not an explicit 16:9 frame")
        ...
        check("(() => { const visual=document.querySelector('.destination-visual'); const style=getComputedStyle(visual); return style.aspectRatio.replaceAll(' ', '')==='16/9' && Math.abs(visual.clientWidth/visual.clientHeight-16/9)<0.02; })()", "Apothecary destination visual is not an explicit 16:9 frame")
