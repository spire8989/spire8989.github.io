...
def run():
    ...
    try:
        ...
        check("game.expedition.returnRewardsRolled && game.summary.returnRewardTier === 'minor' && Object.keys(game.summary.materials).length + game.summary.gold > 0", "Successful return did not roll and report its distance-tier reward")
