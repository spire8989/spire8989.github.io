...
def run():
    ...
    try:
        ...
        check("Boolean(document.querySelector('.journey-controls') && document.querySelector('.expedition-status') && document.querySelector('.strategic-exit') && document.querySelector('.destructive-exit')) && document.querySelector('.journey-summary')?.textContent.includes('pace') && !document.querySelector('.journey-summary')?.textContent.includes('food rate') && document.querySelector('#return-button')?.textContent.includes('Begin Return Journey')", "Expedition lower-half hierarchy did not separate status, journey controls, strategic return, and abandon")
        ...
        check("document.querySelector('.journey-state-banner')?.textContent.includes('Travel Paused')", "Paused journey status was not shown in the Journey dashboard")
        check("Boolean(document.querySelector('.journey-resume-button') && document.querySelector('.paused-actions') && document.querySelector('[data-action=\"make-camp\"]'))", "Paused journey controls did not reveal their contextual actions")
        ...
        check("document.querySelector('#loot-empty-state')?.textContent.includes('Nothing found yet') && document.querySelector('#loot-empty-state')?.hidden === false", "Unsecured Loot zero state is not clean")
