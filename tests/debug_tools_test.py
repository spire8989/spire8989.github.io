    ...
    try:
        ...
        (async () => {
          ...
          try {
            ...
            const changeSeam = document.querySelector("#travel-art .travel-seam-foreground");
            ...
            const foregroundAboveTravelers = Boolean(changeSeam)
              && Number(getComputedStyle(changeSeam).zIndex) > Number(getComputedStyle(document.querySelector(".travelers")).zIndex);
        ...
        check(
            ...
            (async () => {
              ...
              try {
                ...
                await wait(820);
                const carry = document.querySelector("#travel-art .travel-seam-foreground-carry");
